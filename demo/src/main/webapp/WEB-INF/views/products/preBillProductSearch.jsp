...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
  <title>preBillProductSearch </title>
...
<tr>
 ...
 <tr><th>Select first property</th><th>Select second property</th><th>Enter first dimention</th><th>Enter second dimention</th><th>Enter No.of pices</th><th>Enter %</th></tr>
    <tr><td>    <input size=10  type="text"  id="fp" placeholder="Enter first property"> </td>
       ...
       <tr> <td colspan="5"><center><h6 id="err"></h6></center></td><td><button onclick="submitx();">Submit</button></td></tr>
         </table>
...
<td colspan="5"><table  width="100%"><tr><td><center><h1>Prathap shop</h1><h3> Challapalli krishna 521131</h3>phone:9876987634,3636366363</center></td></tr></table> </td><td colspan="1">
<table><tr><td>Date:</td><td id=printDate></td></tr>
     ...
     <tr>  <th >sln</th>
            ...
            <tfoot>
   <tr><td colspan="2"></td><td><table><tr><td>paid Amount=</td><td id="pmt"></td></tr><tr><td>Due=</td><td id="due"></td></tr></table></td><td colspan="4" align="right">Grand Total=</td><td id="gtl"></td></tr>
